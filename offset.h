...
#define GameVars BloodHunt::Variables::Get()
	...
	public:
		...
		DWORD offset_Player_Level = 0x454;
		DWORD offset_player_state = 0x248; //APawn->PlayerState
		DWORD offset_actor_mesh = 0x288; //ACharacter->Mesh
		DWORD offset_bone_array = 0x4B0;//0x4B0 0x480
		DWORD offset_component_to_world = 0x1c0; // 0x14c  0x1c0
		DWORD offset_ranged_weapon_component = 0x4c8;//ATigerCharacter-> UTigerRangedWeaponComponent
		DWORD offset_equipped_weapon_type = 0x2b8;// UTigerRangedWeaponComponent->EquippedWeaponType
		...
		DWORD offset_CurrentShield = 0x6b4;
	};
